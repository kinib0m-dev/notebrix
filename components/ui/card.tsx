  ...
  return (
    <div
      ...
      className={cn(
        ...
        "relative overflow-hidden rounded-xl border border-white/10 dark:border-white/10",
        "bg-white/10 dark:bg-white/5 backdrop-blur-xl",
        "shadow-[0_8px_32px_rgba(31,38,135,0.25)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)]",
